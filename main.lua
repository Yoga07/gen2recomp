...
local HEADLESS = {
  ...
  ["--probe-goldtext"] = "tests.probe_goldtext",
  ["--probe-stdgold"] = "tests.probe_stdgold",
  ["--probe-sheet"] = "tests.probe_sheet",
  ...
  ["--probe-cries"] = "tests.probe_cries",
  ["--probe-picsearch"] = "tests.probe_picsearch",
  ["--probe-picbanks"] = "tests.probe_picbanks",
